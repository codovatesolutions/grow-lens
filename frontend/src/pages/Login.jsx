    ...
    <div className="min-h-screen grid md:grid-cols-2">
      <div className="hidden md:flex flex-col justify-between p-10 bg-secondary text-secondary-foreground">
        ...
        <div>
          ...
          <p className="mt-3 text-secondary-foreground/70 max-w-md">Scores, fixes and content plans grounded in your actual page and your actual profile.</p>
        </div>
      ...
      <div className="flex items-center justify-center p-6 md:p-10">
        <form onSubmit={onSubmit} className="w-full max-w-sm space-y-5" data-testid="login-form">
          ...
          <div className="text-sm text-muted-foreground text-center">No account? <Link to="/signup" className="text-primary hover:underline" data-testid="login-to-signup">Create one</Link></div>
        </form>
      </div>
    </div>
  );
